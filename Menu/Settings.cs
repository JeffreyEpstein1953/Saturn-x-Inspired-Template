...
namespace StupidTemplate
{
    internal class Settings
    {
        ...
        public static ExtGradient[] buttonColors = new ExtGradient[]
        {
            ...
            new ExtGradient{colors = GetSolidGradient(new Color32(166, 57, 255, 255))} // Enabled
        };
        ...
        public static Vector3 menuSize = new Vector3(0.1f, 1.55f, 1.45f); // Depth, Width, Height
        public static int buttonsPerPage = 10;
    }
}
