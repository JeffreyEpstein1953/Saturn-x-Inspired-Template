...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static float nextToggleTime = 0f;
        public static float toggleCooldown = 0.5f;
        // Functions
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                component.position = new Vector3(0.06f, 0f, 0.225f);
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.localPosition = new Vector3(0.56f, 0f, 0.440f - offset * 1.15f);
            ...
            component.localPosition = new Vector3(.064f, 0, .165f - offset / 2.3f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
